...
let defaultEntityTagMap = {
	...
	[ENTITY.IMAGE.type]: ['<img alt="<%= data.description %>" src="<%= data.url %>" sizes="(max-width: 400px) 80vw, 50vw" srcset="<%= data.mobile.url %> 800w,  <%= data.tablet.url %> 1280w, <%= data.desktop.url %> 2400w" class="<%= data.alignment %>">', '</img>'],
